            ...
            <form className="space-y-4 md:space-y-6" action={ formAction }>
                ...
                <div>
                    <div className="flex w-full items-center justify-center px-2">
                        ...
                        <p className="ms-2 text-xs">I have read the <a className="text-blue-600 dark:text-blue-500 hover:underline" href='/documents/health-and-safety-agreement.pdf' target="_blank">health and safety</a> agreement and agree to abide by these rules when on site</p>
                    </div>
                </div>
